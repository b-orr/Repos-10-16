													...
													<tbody>
														<!-- foreach -->
															<tr>
																...
																<td>Foreman</td>
																<td>
																    <select name="" id="" style="width: 100%;border:none">
																    	<option value="">Sub - Foreman</option>
																    	<option value="">Sub - Foreman</option>
																    	<option value="">Sub - Foreman</option>
																    </select>
																</td>
																<td>jjones@waco.com</td>
																<td>555-444-1234</td>
															</tr>
															<tr>
																<td>Steve Jones</td>
																...
																<td>
																	<select name="" id="" style="width: 100%;border:none">
																    	<option value="">GC - Superintendent</option>
																    	<option value="">GC - Superintendent</option>
																    	<option value="">GC - Superintendent</option>
																    </select>
																</td>
																<td>sjones@schmitt.com</td>
																<td>666-777-4567</td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td>
																	<select name="" id="" style="width: 100%;border:none">
																    	<option value="">Engineering Team</option>
																    	<option value="">Engineering Team</option>
																    	<option value="">Engineering Team</option>
																    </select>
																</td>
																<td>jthao@mcclone.net</td>
																<td>253-475-1934</td>
															</tr>
															<tr>
																<td>Chris Town</td>
