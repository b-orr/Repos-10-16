                            ...
                            <div style="padding-left: 20px;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                           <div class="row">
                                              ...
                                              <option value="{{$s->abbrv}}" @if($project->state == $s->abbrv) selected="true" @endif >{{$s->abbrv}}</option>
                                            @endforeach
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-3">
                                         <div class="form-group">
                                             <input type="text" class="form-control" name="bid_site_address" value="{{ $project->bid_site_address }}"   />
                                         </div>
                                     </div>
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-3">
                                         <div class="form-group">
                                             <input type="text" class="form-control" name="bid_username" value="{{ $project->bid_username }}"  />
                                         </div>
                                     </div>
                                     <div class="col-md-3">
                                         <div class="form-group">
