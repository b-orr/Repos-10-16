...
@include('includes._menu_list')
 ...
 <div id="main" role="main">
 			...
 			<div id="ribbon" style="background-color: white;">
 				...
 				<!-- breadcrumb -->
 				<ol class="breadcrumb">
 					<li style="color: black;">Home</li><li style="color: black;">Bid List</li>
 				</ol>
 				<!-- end breadcrumb -->
 																	...
 																	<div class="widget-body">
 																		...
 																		<div class="row">
 																			...
 																			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right"  >
 																				...
 																				<button class="btn btn-success btn-block " onclick="window.location = '{{ url('estimate/create') }}'" style="padding-right: 0px; padding-left: 2px; height: auto;">
 																					Create new Bid
 																				</button>
