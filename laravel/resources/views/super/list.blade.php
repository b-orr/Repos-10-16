...
@include('includes._menu_super')
		...
		<div id="main" role="main">
			...
			<div id="content">
							...
							<div class="col-sm-12">
													...
													<tbody>
														...
														@foreach($lists as $list)
															<tr>
																...
																<td><a href="{{ url('/super/'.$list->id.'/edit') }}"><i class="fa fa-edit"></i></a>&nbsp; |   
																...
																<form action="{{ url('/super/' . $list->id) }}" method="POST"  style="display: inline;">
								...
								<article class="col-lg-2">
									<div class="jarviswidget jarviswidget-color-darken" id="wid-id-22" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false">
										...
										<div class="row">
											<div class="widget-body">
												<button type="button" data-toggle="modal" data-target="#myModal" id="myModalBtn" class="btn btn-success btn-block">
													Add new company
												</button>
											</div>
											<br>
				...
				<form   role="form" method="POST"   action="{{ url('/super') }}">
				{{ csrf_field() }}
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="input" style="font-weight: bold;">Password</label>
