                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" style="border-style: groove; border-width: 2px;">
                                                    <ul class="checkbox"> 
                                                        ...
                                                        @if($region->active == '1')															    <li>
                                                            <input type="checkbox" name="region[]"  value="{{ $region->id }}" @if(array_key_exists($region->id,$list_region)) checked="checked" @endif   />
                                                                   <input type="radio" name="region_id" id="cb{{ $region->id }}" @if(array_key_exists($region->id,$list_region) && $list_region[$region->id]==1) checked="checked" @endif value="{{ $region->id }}" /><label for="cb{{ $region->id }}">{{ $region->name }}</label>
                                                        </li> 
                                                        @endif
                                                        @endforeach
