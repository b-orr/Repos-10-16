...
<?php include '../includes/_menu.php'; ?>
		...
		<div id="main" role="main">
			...
			<div id="ribbon" style="background-color: white;">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li style="color: black;">Home</li><li style="color: black;">Projects</li><li style="color: black;">1001 Broadway</li><li style="color: black;">Submittal</li>
				</ol>
				<!-- end breadcrumb -->
										...
										<form class="smart-form">
											...
											<fieldset>
												<div class="row">
													<section class="col col-3">
														<label class="control-label">
															Submittal Author / Creator
														</label>
													</section>
													<section class="col col-3">
														<div class="form-group">
															<input type="text" name="submitAuthor" class="form-control">
														</div>
													</section>
												</div>
