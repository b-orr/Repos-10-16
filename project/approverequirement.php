	...
	<style type="text/css">
		...
		<div id="main" role="main">
			...
			<div id="ribbon" style="background-color: white;">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li style="color: black;">Home</li><li style="color: black;">Projects</li><li style="color: black;">1001 Broadway</li><li style="color: black;">Equipment</li><li style="color: black;">Overview</li><li style="color: black;">Accept Requirement</li>
				</ol>
				<!-- end breadcrumb -->
