...
<?php include '../includes/_menu.php'; ?>
		...
		<div id="main" role="main">
			...
			<div id="ribbon" style="background-color: white;">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li style="color: black;">Home</li><li style="color: black;">Projects</li><li style="color: black;">1001 Broadway</li><li style="color: black;">Submittals</li>
				</ol>
				<!-- end breadcrumb -->
								...
								<div>
									...
									<div class="widget-body">
										<div class="panel-group smart-accordion-default" id="accordion3">
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne" class="collapsed"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> Draft Submittals </a></h4>
												</div>
										...
										<div class="panel-group smart-accordion-default" id="accordion">
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> Open Submittals </a></h4>
												</div>
												<div id="collapseOne" class="panel-collapse collapse in">
													<table class="table table-bordered table-striped">
															<thead>
										...
										<div class="panel-group smart-accordion-default" id="accordion1">
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo" class="collapsed"> <i class="fa fa-lg fa-angle-down pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> Closed Submittals </a></h4>
												</div>
						...
						<article class="col-xs-10 col-sm-10 col-md-10 col-lg-2">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-9" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								...
								<div>
									...
									<div class="widget-body">
										<div class="col-lg-12">
											<button class="btn btn-success btn-block" data-toggle="modal" data-target="#myModal">New Submittal</button>
										</div>
									</div>
									<!-- end widget content -->
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header" style="background-color: #404040;">
							...
							<h4 class="modal-title" id="myModalLabel" style="color: white; font-weight: bold;">Select Submittal Type</h4>
						</div>
						...
						<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="input" style="font-weight: bold;">Submittal Template</label><br>
						...
						<div class="modal-footer">
							...
							<a href="newsubmittal.php" type="button" class="btn btn-primary">
								Continue
							</a>
						</div>
					</div><!-- /.modal-content -->
