...
<?php include '../includes/_menu.php'; ?>
			...
			<div id="content">
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
						...
						<div id="contentMain" class="col-md-9" style="width: 75%; padding-left: 13px;">
						...
						<div class="col-lg-3 no-padding" id="rightMenu">
							<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
		...
		<input type="checkbox" id="collapseMenu" name="" class="hide">
		<!-- END MAIN PANEL -->
