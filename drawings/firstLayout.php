												...
												<ul class="bs-glyphicons">
													<a href="drawingList.html" class="txt-color-darken">
														<li style="display: flex; flex-direction: column;">
															...
															<div style="display: flex; justify-content: space-around;align-items: center; padding: 0 50px;">
																...
																<div>
																	<p style="font-size: 15px;">Drawings:<span class="drawings-number"> 5</span></p>
																	<p style="font-size: 11px;">Last change:<br>Zlatko Bogoevski
																<br>
													...
													<li style="display: flex; flex-direction: column;">
															...
															<div style="display: flex; justify-content: space-around;align-items: center; padding: 0 50px;">
																<span class="glyphicon glyphicon-folder-close"></span>
																<div>
																	<p style="font-size: 15px;">Drawings:<span class="drawings-number"> 15</span></p>
																	<p style="font-size: 11px;">Last change:<br>Bruce Orr
																<br>
																<small><i>May 15, 2017</i></small></p>
																</div>													
															</div>
														</li>
													</a>
