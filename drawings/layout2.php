...
<?php include '../includes/_menu2.php'; ?>
	<style type="text/css">
			.bs-glyphicons {
				padding-left: 0;
				padding-bottom: 1px;
													...
													<a href="drawingList.php" class="txt-color-darken">
														<li class="folder-li" style="">
															...
															<div class="folder-data" style="">
																<span class="glyphicon glyphicon-folder-close"></span>
																<div>
																	<p class="folder-info" style="">Drawings:<span class="drawings-number"> 17</span></p>
																	<p class="folder-last-change" style="">Last change:<br>Bruce Orr
																<br>
													...
													<a href="drawingList.php" class="txt-color-darken">
														<li class="folder-li" style="">
															...
															<div class="folder-data" style="">
																<span class="glyphicon glyphicon-folder-close"></span>
																<div>
																	<p class="folder-info" style="">Drawings:<span class="drawings-number"> 2</span></p>
