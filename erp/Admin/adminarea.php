...
<?php include '../includes/_menu.php'; ?>
		...
		<div id="main" role="main">
			...
			<div id="ribbon" style="background-color: white;">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li style="color: black;">Admin</li><li style="color: black;">Regions</li>
				</ol>
				<!-- end breadcrumb -->
									...
									<div class="widget-body no-padding">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											<tbody>
												...
												<tr>
													<td>South Texas Office</td>
													<td><a href="#"><i class="fa fa-edit"></i></a>&nbsp; | <a href="#">&nbsp;<i class="fa fa-trash-o"></i></a></td>
												</tr>
												<tr>
													<td>Northern CA Office</td>
													<td><a href="#"><i class="fa fa-edit"></i></a>&nbsp; | <a href="#">&nbsp;<i class="fa fa-trash-o"></i></a></td>
												</tr>
												<tr>
													<td>Southern CA Office</td>
													<td><a href="#"><i class="fa fa-edit"></i></a>&nbsp; | <a href="#">&nbsp;<i class="fa fa-trash-o"></i></a></td>
												</tr>
											</tbody>
										</table>
